...
function mysql_prep($string){
	global $Database;
	$decoded_string = utf8_encode($string);
	return mysqli_real_escape_string($Database->con, $decoded_string);
...
function find_username($username) {
	global $Database;
	$safe_username = mysqli_real_escape_string($Database->con, $username);
